    ...
    public CommandLineRunner autoSaveItems(ItemRepository itemRepository) {
        return args -> {
            ...
            if (items.isEmpty()) {
                ...
                itemRepository.save(new Item("Pantalones de hielo", "pants", (short) 1, 1, 0, 0, 1, 1));
                itemRepository.save(new Item("Guantes de hielo", "gloves", (short) 1, 1, 0, 0, 1, 1));
                itemRepository.save(new Item("Botas de hielo", "boots", (short) 1, 1, 0, 0, 1, 1));
                itemRepository.save(new Item("Barca de hielo", "ship", (short) 1, 1, 1, 1, 1, 1));
                itemRepository.save(new Item("Alas de hielo", "wings", (short) 1, 1, 1, 1, 1, 1));
            }
        };
    }
}
